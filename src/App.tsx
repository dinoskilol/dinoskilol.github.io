...
const PROJECTS = [
  ...
  {
    title: '/Azubot',
    subtitle: 'AI assistant for German apprentices',
    tags: ['Web', 'AI', 'Fullstack'],
    techs: ['React', 'TypeScript', 'DeepSeek', 'Vite'],
    color: '#a78bfa',
    image: 'azubot.png',
    links: {
      project: 'https://dinoskilol.github.io/azubot/',
      github: 'https://github.com/dinoskilol/azubot',
      docs: 'https://github.com/dinoskilol/azubot/blob/main/README.md',
    },
  },
  {
    title: '/PS-Companion',
